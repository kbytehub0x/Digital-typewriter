...
![Typewriter Interface Preview](preview.png)
...
```
2.Paste the following configuration, replacing /PATH/TO/YOUR/ with your exact folder location:
 ```text
[Desktop Entry]
Type=Application
...
3.Save and close (Ctrl+O followed by Enter, then Ctrl+X).
